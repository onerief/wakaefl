  ...
  return (
    <nav className="sticky top-16 sm:top-32 z-40 w-full bg-brand-primary/90 backdrop-blur-xl border-b border-white/5 shadow-2xl overflow-visible">
      <div className="container mx-auto px-2 sm:px-4 overflow-visible">
        <div className="flex items-center justify-center py-2.5 sm:py-5 gap-1.5 sm:gap-6 overflow-x-auto no-scrollbar">
            
            {/* HOME BUTTON */}
            {currentView !== 'home' && (
                <button
                    onClick={() => setView('home')}
                    className="px-3 sm:px-8 py-2 sm:py-3 rounded-xl text-[9px] sm:text-sm font-black uppercase tracking-widest transition-all flex items-center gap-1.5 whitespace-nowrap border text-brand-light border-white/5 hover:text-white hover:bg-white/5 hover:border-brand-vibrant/30 group shrink-0"
                >
            ...
            <div className="relative shrink-0" ref={dropdownRef}>
                <button
                    ...
                    className={`px-3 sm:px-8 py-2 sm:py-3 rounded-xl text-[9px] sm:text-sm font-black uppercase tracking-widest transition-all flex items-center gap-1.5 whitespace-nowrap border ${
                        isLigaActive 
            ...
            <button
                ...
                className={`px-3 sm:px-8 py-2 sm:py-3 rounded-xl text-[9px] sm:text-sm font-black uppercase tracking-widest transition-all flex items-center gap-1.5 whitespace-nowrap border shrink-0 ${
