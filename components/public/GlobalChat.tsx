                ...
                {currentUser ? (
                    <form onSubmit={handleSend} className="flex gap-2">
                        <input 
                            ...
                            className="flex-1 bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white placeholder:text-brand-light/50 focus:border-brand-vibrant outline-none transition-all"
                        />
                        <button 
                            type="submit" 
